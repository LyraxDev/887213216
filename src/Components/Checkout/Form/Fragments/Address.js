...
const Address = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <input id="cep" name="cep" placeholder="Digite seu CEP"  text="63575000" className={styles.input} type="text" maxLength="8" onChange={(event) => { setCep(event.target.value); setError(false) }} onBlur={validateCep} value={cep} />
